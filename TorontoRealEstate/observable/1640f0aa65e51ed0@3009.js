...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([["toronto_real_estate_d3@1.csv",new URL("./files/1c7d34998fe74802fddc1b966e126b504b027d555b58a28e3297dd9bb72a506d27b340edd30c94c1e0b31b9bbdaef156df190c6302fc06a671c883573a2d3d45",import.meta.url)]]);
...
d3.csvParse(await FileAttachment("toronto_real_estate_d3@1.csv").text(), d3.autoType)
)});
  main.variable(observer()).define(["md"], function(md){return(
